...
import { Options, VisualMapType, Item } from '../type';
...
async function getVisualMapOptions(lang: string, type: string): Promise<Item> {
    ...
    const item = visualMapOptionsName.map((item: string) => {
